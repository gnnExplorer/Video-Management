...
<body class="w100">
	...
	<div id="app">
		<!--banner图-->
		<div class="banner" style="background-image: url('${pageContext.request.contextPath }/static/img/banner-${subjectId}.jpg')"></div>
	...
	<script type="text/javascript">
		function getVideo(id){
			...
			location.href='/vm-web/front/video/index.do?videoId='+id+'&subjectId='+subjectId;
		}
	</script>
